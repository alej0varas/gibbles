...
METADATA = {
    ...
    'description':      'Nibbles like game. much more fun, moves on all directions and jump, can be played with mouse.',
    'author':           'Alejandro Varas',
    #'author_email':     '',
    'url':              'http://gibbles.alej0.tk',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'gibbles': 'gibbles',
                   },
    'packages': ['gibbles',
                ],
    'scripts': ['scripts/gibbles'],
}
...
_DATA_DIR = os.path.join('gibbles', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'gibbles': data_dirs}
